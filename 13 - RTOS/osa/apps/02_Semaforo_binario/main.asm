...
;main.c,24 :: 		OS_Task_Create(0, Task_LED2);
	...
	MOVWF       FARG__OS_Task_Create_TaskAddr+3 
	CALL        __OS_Task_Create+0, 0
;main.c,27 :: 		OS_Bsem_Reset(BS_LED0);
	BCF         __OS_Bsems+0, 0 
;main.c,28 :: 		OS_Bsem_Reset(BS_LED1);
	BCF         __OS_Bsems+0, 1 
;main.c,29 :: 		OS_Bsem_Reset(BS_LED2);
	BCF         __OS_Bsems+0, 2 
;main.c,31 :: 		OS_EI();
...
;main.c,37 :: 		void Task_LED0(void)
;main.c,40 :: 		OS_Bsem_Set(BS_LED0);
	BSF         __OS_Bsems+0, 0 
;main.c,42 :: 		for(;;)
L_Task_LED035:
;main.c,45 :: 		OS_Bsem_Wait(BS_LED0);
...
;main.c,47 :: 		LATD.RD0 = ~LATD.RD0;
	BTG         LATD+0, 0 
;main.c,48 :: 		OS_Delay(300);
	MOVLW       44
	...
	NOP
;main.c,50 :: 		OS_Bsem_Reset(BS_LED0);
	MOVLW       254
	ANDWF       __OS_Bsems+0, 1 
;main.c,51 :: 		OS_Bsem_Set(BS_LED1);
	BSF         __OS_Bsems+0, 1 
;main.c,53 :: 		}
	GOTO        L_Task_LED035
;main.c,54 :: 		}
...
;main.c,56 :: 		void Task_LED1(void)
;main.c,58 :: 		for(;;)
L_Task_LED138:
;main.c,60 :: 		OS_Bsem_Wait(BS_LED1);
	CALL        __OS_EnterWaitMode+0, 0
	NOP
	MOVLW       2
	ANDWF       __OS_Bsems+0, 0 
...
L__Task_LED158:
	...
	MOVLW       253
	ANDWF       __OS_Bsems+0, 1 
;main.c,62 :: 		LATD.RD1 = ~LATD.RD1;
	BTG         LATD+0, 1 
;main.c,63 :: 		OS_Delay(300);
	MOVLW       44
	MOVWF       FARG__OS_InitDelay_Delay+0 
	MOVLW       1
	MOVWF       FARG__OS_InitDelay_Delay+1 
	...
	CALL        __OS_ReturnSave+0, 0
	NOP
;main.c,65 :: 		OS_Bsem_Reset(BS_LED1);
	MOVLW       253
	ANDWF       __OS_Bsems+0, 1 
;main.c,66 :: 		OS_Bsem_Set(BS_LED2);
	BSF         __OS_Bsems+0, 2 
;main.c,67 :: 		}
	GOTO        L_Task_LED138
;main.c,68 :: 		}
...
;main.c,70 :: 		void Task_LED2(void)
;main.c,72 :: 		for(;;)
L_Task_LED241:
;main.c,74 :: 		OS_Bsem_Wait(BS_LED2);
	CALL        __OS_EnterWaitMode+0, 0
	NOP
	MOVLW       4
	ANDWF       __OS_Bsems+0, 0 
...
L__Task_LED260:
	...
	MOVLW       251
	ANDWF       __OS_Bsems+0, 1 
;main.c,76 :: 		LATD.RD2 = ~LATD.RD2;
	BTG         LATD+0, 2 
;main.c,77 :: 		OS_Delay(300);
	MOVLW       44
	MOVWF       FARG__OS_InitDelay_Delay+0 
	MOVLW       1
	MOVWF       FARG__OS_InitDelay_Delay+1 
	...
	CALL        __OS_ReturnSave+0, 0
	NOP
;main.c,79 :: 		OS_Bsem_Reset(BS_LED2);
	MOVLW       251
	ANDWF       __OS_Bsems+0, 1 
;main.c,80 :: 		OS_Bsem_Set(BS_LED0);
	BSF         __OS_Bsems+0, 0 
;main.c,81 :: 		}
	GOTO        L_Task_LED241
;main.c,82 :: 		}
