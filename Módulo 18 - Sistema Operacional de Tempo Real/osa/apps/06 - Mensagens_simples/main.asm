...
;main.c,45 :: 		for(;;){
L_Task_LCD37:
;main.c,46 :: 		if(OS_Smsg_Check(msg_adc1)){
	MOVF        _msg_adc1+1, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L__Task_LCD65
...
L__Task_LCD65:
	BTFSC       STATUS+0, 2 
	GOTO        L_Task_LCD40
;main.c,47 :: 		OS_Smsg_Accept(msg_adc1, msg);
	MOVF        _msg_adc1+0, 0 
	...
	CLRF        _msg_adc1+0 
	CLRF        _msg_adc1+1 
;main.c,48 :: 		WordToStr(msg, str);
	MOVF        Task_LCD_msg_L0+0, 0 
	MOVWF       FARG_WordToStr_input+0 
	MOVF        Task_LCD_msg_L0+1, 0 
	MOVWF       FARG_WordToStr_input+1 
	MOVLW       Task_LCD_str_L0+0
	MOVWF       FARG_WordToStr_output+0 
	MOVLW       hi_addr(Task_LCD_str_L0+0)
	MOVWF       FARG_WordToStr_output+1 
	CALL        _WordToStr+0, 0
;main.c,49 :: 		Lcd_Out(1,1,str);
	MOVLW       1
...
;main.c,50 :: 		}
L_Task_LCD40:
;main.c,51 :: 		if(OS_Smsg_Check(msg_adc2)){
	MOVF        _msg_adc2+1, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L__Task_LCD66
...
L__Task_LCD66:
	BTFSC       STATUS+0, 2 
	GOTO        L_Task_LCD41
;main.c,52 :: 		OS_Smsg_Accept(msg_adc2, msg);
	MOVF        _msg_adc2+0, 0 
	MOVWF       Task_LCD_msg_L0+0 
	MOVF        _msg_adc2+1, 0 
	MOVWF       Task_LCD_msg_L0+1 
...
;main.c,60 :: 		void Task_ADC1(void){
;main.c,64 :: 		OS_Smsg_Create(msg_adc1);
	CLRF        _msg_adc1+0 
	CLRF        _msg_adc1+1 
;main.c,66 :: 		for(;;){
L_Task_ADC142:
;main.c,67 :: 		leitura_adc = ADC_Read(14);
	MOVLW       14
	MOVWF       FARG_ADC_Read_channel+0 
	CALL        _ADC_Read+0, 0
	MOVF        R0, 0 
	MOVWF       Task_ADC1_leitura_adc_L0+0 
	MOVF        R1, 0 
	MOVWF       Task_ADC1_leitura_adc_L0+1 
;main.c,70 :: 		OS_Smsg_Send(msg_adc1, leitura_adc);
	MOVF        _msg_adc1+1, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L__Task_ADC168
...
L_Task_ADC145:
	MOVF        Task_ADC1_leitura_adc_L0+0, 0 
	MOVWF       _msg_adc1+0 
	MOVF        Task_ADC1_leitura_adc_L0+1, 0 
	MOVWF       _msg_adc1+1 
;main.c,72 :: 		OS_Cond_Wait(!OS_Smsg_Check(msg_adc1));
	CALL        __OS_EnterWaitMode+0, 0
	NOP
	MOVF        _msg_adc1+1, 0 
	XORLW       0
...
;main.c,78 :: 		void Task_ADC2(void){
;main.c,82 :: 		OS_Smsg_Create(msg_adc2);
	CLRF        _msg_adc2+0 
	CLRF        _msg_adc2+1 
;main.c,84 :: 		for(;;){
L_Task_ADC246:
;main.c,85 :: 		leitura_adc = ADC_Read(15);
	MOVLW       15
	MOVWF       FARG_ADC_Read_channel+0 
	CALL        _ADC_Read+0, 0
	MOVF        R0, 0 
	MOVWF       Task_ADC2_leitura_adc_L0+0 
	MOVF        R1, 0 
	MOVWF       Task_ADC2_leitura_adc_L0+1 
;main.c,88 :: 		OS_Smsg_Send(msg_adc2, leitura_adc);
	MOVF        _msg_adc2+1, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L__Task_ADC272
...
L__Task_ADC273:
	...
	CALL        __OS_CheckEvent+0, 0
L_Task_ADC249:
	MOVF        Task_ADC2_leitura_adc_L0+0, 0 
	MOVWF       _msg_adc2+0 
	MOVF        Task_ADC2_leitura_adc_L0+1, 0 
	MOVWF       _msg_adc2+1 
;main.c,90 :: 		OS_Cond_Wait(!OS_Smsg_Check(msg_adc2));
	CALL        __OS_EnterWaitMode+0, 0
	NOP
	MOVF        _msg_adc2+1, 0 
	XORLW       0
...
;main.c,96 :: 		void Task_LED(void){
;main.c,97 :: 		for(;;)
L_Task_LED50:
;main.c,99 :: 		LATD.RD0 = ~LATD.RD0;
	BTG         LATD+0, 0 
;main.c,100 :: 		OS_Delay(300);
	MOVLW       44
	MOVWF       FARG__OS_InitDelay_Delay+0 
	MOVLW       1
	MOVWF       FARG__OS_InitDelay_Delay+1 
